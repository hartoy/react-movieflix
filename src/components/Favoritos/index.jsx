...
const removeFav = (e) => {
 ...
 const RemoveFavHandler = (e) => {
    ...
    return(
      ...
      <div><Button className="delFav"  onClick={removeFav} >Clear Favorites</Button></div>
          ...
          return(
              ...
              <Card className="my-2 h-100">
                  ...
                  <Card.Body>
                   ...
                   <Button className="detallesFav" as={Link} to={`/movie-details/${oneMovie.id}`}>Details</Button>
                   <Button className="delFav2" onClick={RemoveFavHandler}>Remove</Button>    
